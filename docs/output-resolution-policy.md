...
**Status:** exact stored-zero policy and explicit positive-threshold cell-mesh simplification
implemented
...
Pre-storage f64 collision telemetry and angular convenience constructors remain deferred. This
