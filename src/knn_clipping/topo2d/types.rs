...
pub(crate) const MAX_POLY_VERTICES: usize = 24;
pub(crate) type PlaneId = u32;
pub(crate) const INVALID_PLANE_ID: PlaneId = PlaneId::MAX;
...
impl PolyBuffer {
    ...
    pub(crate) fn init_bounding(&mut self, bound: f64) {
        self.us[0] = 0.0;
        self.vs[0] = bound;
    ...
    #[inline]
    pub(crate) fn has_bounding_ref(&self) -> bool {
