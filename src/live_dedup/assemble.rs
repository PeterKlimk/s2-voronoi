...
pub(super) fn assemble_sharded_live_dedup(
    ...
    let sub_phases = DedupSubPhases {
        ...
        edge_check_overflow_active_pairs: overflow_timing.active_pairs,
        edge_check_overflow_max_pair_records: overflow_timing.max_pair_records,
        edge_check_overflow_dependency_levels: overflow_timing.dependency_levels,
        edge_check_overflow_max_level_pairs: overflow_timing.max_level_pairs,
        edge_check_overflow_max_level_records: overflow_timing.max_level_records,
        edge_check_overflow_skinny_levels: overflow_timing.skinny_levels,
        edge_check_overflow_skinny_level_records: overflow_timing.skinny_level_records,
        edge_check_overflow_weighted_critical_records: overflow_timing.weighted_critical_records,
