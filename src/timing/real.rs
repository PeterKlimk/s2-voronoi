...
pub(crate) struct DedupSubPhases {
    ...
    pub edge_check_overflow_active_pairs: u64,
    pub edge_check_overflow_max_pair_records: u64,
    pub edge_check_overflow_dependency_levels: u64,
    pub edge_check_overflow_max_level_pairs: u64,
    pub edge_check_overflow_max_level_records: u64,
    pub edge_check_overflow_skinny_levels: u64,
    pub edge_check_overflow_skinny_level_records: u64,
    pub edge_check_overflow_weighted_critical_records: u64,
